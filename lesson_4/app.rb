...
module Lesson4
  ...
  module App
    ...
    def self.l10n
      YAML.load_file(TrueWay::Config.l10n_path, symbolize_names: true)
    rescue Errno::ENOENT, Psych::SyntaxError => e
      raise TrueWay::Config::ConfigurationError, "Localization file error: #{e.message}"
    end
    ...
    def self.db_adapter = TrueWay::Config.db_adapter
  end
end
